...
namespace HolidayMakerClient.Model
{
    public class Home : INotifyPropertyChanged
    {
        ...
        #region Constructors
        public Home(string homeType, int rooms,string location, decimal price,bool hasBalcony,bool allowPets,bool hasWifi,bool hasHalfPension,bool hasFullPension, bool hasAllInclusive, bool hasExtraBed,int cityDistance,int beachDistance,int numberOfBeds,bool hasPool,bool allowSmoking,string description, int userId)
        {
            HomeType = homeType;
            Rooms = rooms;
            Location = location;
